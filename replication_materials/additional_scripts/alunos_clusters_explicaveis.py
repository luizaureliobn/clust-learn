...
from clearn.data_preprocessing import (
    impute_missing_values, remove_outliers,
    missing_values_heatmap, plot_imputation_distribution_assessment
)
...
dr = DimensionalityReduction(
    df_clean, num_vars=num_vars, cat_vars=cat_vars,
    num_algorithm='spca', cat_algorithm='mca'
)
...
dr.plot_num_explained_variance(0.5, plots=['cumulative', 'normalized'],
    output_path='img/explained_variance.jpg')
...
classifier.plot_shap_importances_beeswarm(class_id=0, output_path='img/local_shap_cluster0.jpg')
